...
public:
    ...
    void copy_to(const std::shared_ptr<ov::ITensor>& dst, size_t src_offset, size_t dst_offset, ov::Shape shape) const override;
    void copy_from(const std::shared_ptr<ov::ITensor>& src, size_t src_offset, size_t dst_offset, ov::Shape shape) override;
