...
struct Subgraph : public ImplementationManager {
    OV_GPU_PRIMITIVE_IMPL("jit::subgraph")

    explicit Subgraph(shape_types shape_type, ValidateFunc vf = nullptr) : ImplementationManager(impl_types::ocl, shape_type, std::move(vf)) {}
