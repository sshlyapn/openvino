...
KERNEL(pa_sdpa_opt)(
    ...
    //     printf("heads_group_idx=%d head_num_idx=%d iter_heads_num=%d. HEADS_PER_WI=%d ITERATIONS_PER_KV_HEADS_GROUP=%d HEADS_LEFTOVERS_NUM=%d\n", heads_group_idx, head_num_idx, iter_heads_num, HEADS_PER_WI, ITERATIONS_PER_KV_HEADS_GROUP, HEADS_LEFTOVERS_NUM);
    // }
#else
