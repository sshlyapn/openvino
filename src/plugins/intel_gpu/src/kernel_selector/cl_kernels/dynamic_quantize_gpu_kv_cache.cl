    ...
    )
{
    ...
    // int8 arg = (0, 0, 1, 1, 2, 2, 3, 3);
    // int acc = intel_sub_group_i8_i8_matrix_mad_k32(as_int(sglid), arg, as_int(sglid));
    // int  intel_sub_group_i8_i8_matrix_mad_k32(int   a, int8  b, int  acc);
