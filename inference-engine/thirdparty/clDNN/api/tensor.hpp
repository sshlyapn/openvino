...
o/32 i/32 32i y x 32o
os_is_isv32_yx_osv32 64 64 2 2
y0xo: o0 .. o31
y0x1: o0 .. o31
y1xo: o0 .. o31
y1x1: o0 .. o31
*/
    ...
    static const format_traits& traits(type fmt) {
        static const std::map<type, format_traits> traits {
                ...
                { i_yxs_os_yxsv2_osv16,                        { 1, 1, 2, 0, 1, "iyxo",   "oixy",       {{0, 16}}}},
    ...
    */
    ...
    size_t get_linear_offset(const tensor& coord, cldnn::format fmt) const {
        ...
        if (fmt == cldnn::format::byxf_af32 && !(is_aligned_to(my_sizes[3], 32))) {
            ...
            my_sizes[3] = align_to(my_sizes[1], 32);
        } else if (fmt == cldnn::format::i_yxs_os_yxsv2_osv16) {
            const auto yxsv = 2;
