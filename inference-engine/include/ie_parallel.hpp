...
void for_6d(const int& ithr, const int& nthr, const T0& D0, const T1& D1, const T2& D2, const T3& D3, const T4& D4, const T5& D5,
            const F& func) {
...
template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename F>
void parallel_for5d(const T0& D0, const T1& D1, const T2& D2, const T3& D3, const T4& D4, const T5& D5, const F& func) {
#if IE_THREAD == IE_THREAD_TBB
...
#elif IE_THREAD == IE_THREAD_SEQ
    for_5d(0, 1, D0, D1, D2, D3, D4, D5, func);
#endif
}
